...
#define GCCONV StringConvertUtils::Instance()
#define GCU2A(U) StringConvertUtils::Instance()->WToA(StringConvertUtils::Instance()->UTF8ToW(U))
#define GCA2U(A) StringConvertUtils::Instance()->WToUTF8(StringConvertUtils::Instance()->AToW(A))
