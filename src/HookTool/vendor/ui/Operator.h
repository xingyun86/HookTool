...
#define START_ENTRY_NOONLY __DEF_APP_DIR__ int main(int argc,char** argv){__DEF_APP_DIR_INIT__(*__argv);CSecurityProtects::Inst()->CheckValid();return(__user_task(APP_DIR,__argc,__argv));}
#endif
